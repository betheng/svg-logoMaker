...
describe('setShape', () => {
  ...
  test('should render a Square correctly', () => {
    ...
    expect(svg).toEqual(expect.stringContaining('<rect width="200" height="200" fill="crimson"/>'));
    expect(svg).toEqual(expect.stringContaining('text x="100" y="125" font-size="70" text-anchor="middle" fill="whitesmoke">AYO</text'));
  });
  ...
  test('should render a Triangle correctly', () => {
    ...
    expect(svg).toEqual(expect.stringContaining('<text x="100" y="185" font-size="70" text-anchor="middle" fill="yellow">BAE</text>'));
  });
});
